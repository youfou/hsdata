...
class HearthStatsDecks(Decks):
    ...
    def __init__(self, email=None, password=None, json_path=None, auto_load=True):
        ...
        注册页面地址: http://hearthstats.net/users/sign_up
        :param email: 登录邮箱
        :param password: 登录密码
        """
    ...
    def search_online(
        ...
        crawler_process = CrawlerProcess({'ITEM_PIPELINES': {'hsdata.hearthstats.HearthStatsScrapyPipeline': 1}})
...
class HearthStatsScrapySpider(scrapy.Spider):
    ...
    def __init__(self, decks, deck_ids):
